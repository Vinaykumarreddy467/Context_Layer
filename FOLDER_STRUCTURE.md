...
│   ├── eval_fixture.py                 # Deterministic retrieval-eval fixture + generated gold set
│   ├── run_mcp.py
│   ├── run_mcp.ps1
...
| `python scripts/eval_fixture.py` | Create the deterministic retrieval-eval fixture and gold set (`output/eval/gold_set.json`); `--cleanup` deletes the fixture handoffs. |
...
- `output/` — generated artifacts such as retrieval-eval gold sets (`output/eval/gold_set.json`).
- `CONTEXT.md` — generated by `sync` in the project dir; not source.
